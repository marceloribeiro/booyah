    ...
    def copy_folder_tree_with_prompt(self, source_folder, destination_folder):
        try:
            for root, _, files in os.walk(source_folder):
                ...
                print(f'{relative_root} - {destination_root}')
                ...
                for file_name in files:
                    ...
                    if os.path.exists(destination_file):
                        ...
                        if user_input == 'r':
                            ...
                            print(f"File '{source_file}' replaced in '{destination_file}'.")
                        elif user_input == 'i':
                            # Ignore and do not copy
                            print(f"File '{source_file}' was not copied to '{destination_file}' (user choice: Ignore).")
                        else:
            ...
            print(f"Folder tree from '{source_folder}' successfully copied to '{destination_folder}'.")
